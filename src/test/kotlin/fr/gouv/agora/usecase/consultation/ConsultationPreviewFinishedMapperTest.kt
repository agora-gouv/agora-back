...
class ConsultationPreviewFinishedMapperTest {
    ...
    companion object {
        ...
        fun updateLabelTestCases() = arrayOf(
            ...
            input(
                testName = "when updateDate < serverDate < updateDate+30d - should return updateLabel",
            ...
            input(
                testName = "when updateDate < updateDate+30d < serverDate - should return null updateLabel",
                serverDate = LocalDateTime.of(2024, Month.FEBRUARY, 10, 12, 30),
                updateDate = LocalDateTime.of(2024, Month.JANUARY, 1, 12, 30),
                updateLabel = "New update !",
                expectedUpdateLabel = null,
            ),
            ...
            input(
                testName = "when updateDate+30d = serverDate - should return updateLabel",
                serverDate = LocalDateTime.of(2024, Month.JANUARY, 31, 12, 30),
                updateDate = LocalDateTime.of(2024, Month.JANUARY, 1, 12, 30),
                updateLabel = "New update !",
                expectedUpdateLabel = "New update !",
            ),
            input(
                testName = "when updateDate+30d + 1s = serverDate - should return null updateLabel",
                serverDate = LocalDateTime.of(2024, Month.JANUARY, 31, 12, 30, 1),
                updateDate = LocalDateTime.of(2024, Month.JANUARY, 1, 12, 30),
                updateLabel = "New update !",
                expectedUpdateLabel = null,
            ),
