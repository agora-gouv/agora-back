...
INSERT INTO consultations(id, title, start_date, end_date, cover_url, question_count, estimated_time, participant_count_goal, description, tips_description, thematique_id) VALUES (
    ...
    'https://content.agora.beta.gouv.fr/covoiturage.png',
    '12 questions',
    '5 minutes',
    10000,
...
INSERT INTO consultation_updates(id, step, description, consultation_id, explanations_title, video_title, video_intro, video_url, video_width, video_height, video_transcription, conclusion_title, conclusion_description) VALUES (
    ...
    '',
    'https://content.agora.beta.gouv.fr/AgoraMerciVideo.mp4',
    1920,
    1080,
...
INSERT INTO explanations(id, title, intro, image_url, description, consultation_updates_id, toggleable) VALUES (
    ...
    'https://content.agora.beta.gouv.fr/covoiturage_tags.png',
    '',
    '9e828256-cca9-4078-bf1b-c4b958d61aa4',
    'true'
...
INSERT INTO explanations(id, title, intro, image_url, description, consultation_updates_id, toggleable) VALUES (
    ...
    'https://content.agora.beta.gouv.fr/covoiturage_graphe.png',
...
INSERT INTO consultations(id, title, start_date, end_date, cover_url, question_count, estimated_time, participant_count_goal, description, tips_description, thematique_id) VALUES (
    ...
    'https://content.agora.beta.gouv.fr/education.png',
    '12 questions',
    '10 minutes',
    10000,
...
INSERT INTO consultations(id, title, start_date, end_date, cover_url, question_count, estimated_time, participant_count_goal, description, tips_description, thematique_id) VALUES (
    ...
    'https://content.agora.beta.gouv.fr/climate.jpeg',
    '11 questions',
    '10 minutes',
    10000,
...
INSERT INTO consultations(id, title, start_date, end_date, cover_url, question_count, estimated_time, participant_count_goal, description, tips_description, thematique_id) VALUES (
    ...
    'https://content.agora.beta.gouv.fr/energie.jpg',
    '10 questions',
    '7 minutes',
    10000,
